...
> **AGENTS.md parity note (2026-05-31, Rafa/CLI):** Mirrored from the CLAUDE.md canonical (v2026.05.4) to restore parity after AGENTS.md had drifted to an older AIR-Hub-era fork (no Mentor mode contract, pre-MOTU-M4 signal chain). CLAUDE.md is the parallel canonical; keep them in parity. Prior AGENTS.md content is preserved in git history at commit 56bbe13.
